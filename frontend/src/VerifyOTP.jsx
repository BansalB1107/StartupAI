...
import { Lock, Loader2, ArrowRight, RefreshCw, ShieldCheck } from 'lucide-react';
import API from './api';
...
// Renders the registration OTP verification interface to activate new accounts and grant dashboard access.
function VerifyOTP() {
  ...
  // Submits the provided OTP to securely verify the new account and grant dashboard access.
  ...
  // Requests a fresh registration OTP from the server if the previous code has expired.
        ...
        >
          ...
          <div className="p-8 md:p-10 space-y-7">
            ...
            <div className="text-center space-y-3">
              ...
              <div>
                <h1 className="text-3xl font-black text-[var(--text)] tracking-tight">Verify Account</h1>
                <p className="text-[var(--text-light)] text-sm mt-1">Enter the code sent to</p>
            ...
            <form onSubmit={(e) => handleVerify(e)} className="space-y-5">
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-[var(--text-light)] uppercase tracking-widest">Verification Code</label>
              ...
              >
                ...
                {loading
                  ...
                  : <><ShieldCheck className="w-4 h-4" /> Verify & Activate <ArrowRight className="w-4 h-4" /></>
                }
              </motion.button>
            </form>
